...
const SizedBox hSizedBox1 = SizedBox(height: vBox1);
const SizedBox hSizedBox2 = SizedBox(height: vBox2);
const SizedBox hSizedBox3 = SizedBox(height: vBox3);
const SizedBox hSizedBox4 = SizedBox(height: vBox4);
